...
class index extends Component {
    ...
    async currentTopSongs(){
        let res = await topSongs({type:this.state.types[this.state.selectIndex].type})
        // console.log(res)
        this.setState({
    ...
    render() {
        const {types,tableData,selectIndex} =this.state
        return (
